...
namespace RentalKendaraan_091.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            var rental_KendaraanContext = _context.Customer.Include(c => c.IdCustomer1).Include(c => c.IdCustomerNavigation);
        ...
        {
            ViewData["IdCustomer"] = new SelectList(_context.Peminjaman, "IdPeminjaman", "IdPeminjaman");
        ...
        public async Task<IActionResult> Create([Bind("IdCustomer,NamaCustomer,Nik,Alamat,NoHp,IdGender")] Customer customer)
        {
            ...
            ViewData["IdCustomer"] = new SelectList(_context.Peminjaman, "IdPeminjaman", "IdPeminjaman", customer.IdCustomer);

...
namespace RentalKendaraan_091.Controllers
{
    public class JaminansController : Controller
    {
        ...
        {
            var rental_KendaraanContext = _context.Jaminan.Include(j => j.IdJaminanNavigation);
        ...
        {
            ViewData["IdJaminan"] = new SelectList(_context.Peminjaman, "IdPeminjaman", "IdPeminjaman");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdJaminan,NamaJaminan")] Jaminan jaminan)
        {
            ...
            ViewData["IdJaminan"] = new SelectList(_context.Peminjaman, "IdPeminjaman", "IdPeminjaman", jaminan.IdJaminan);
            return View(jaminan);
        }
